...
public class LaporSedang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lapor_sedang);


        recyclerView = (RecyclerView)findViewById(R.id.recyclerLaporSedang);
    ...
    private void ambilData() {
        ...
        SedangInterface api = RetrofitBuilder.getSedangService();
        retrofit2.Call<ListLapor> call = api.ambilDataSedangProses();
            ...
            public void onResponse(retrofit2.Call<ListLapor> call, Response<ListLapor> response) {
                ...
                if (response.isSuccessful()) {
                    if (response.body().getSuccess().toString().equals("true")) {
                        ...
                        AdapterSedang adapter = new AdapterSedang(listData, LaporSedang.this);
                        ...
                        Toast.makeText(LaporSedang.this, response.body().getMessage().toString(), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(LaporSedang.this, "Respones is Not Succesfull", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(retrofit2.Call<ListLapor> call, Throwable t) {
                Toast.makeText(LaporSedang.this, "Response Failure", Toast.LENGTH_SHORT).show();
            }
