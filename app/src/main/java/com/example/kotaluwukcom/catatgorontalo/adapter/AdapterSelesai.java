...
public class AdapterSelesai extends RecyclerView.Adapter<AdapterSelesai.MyHolder> {
    ...
    public AdapterSelesai(ArrayList<LaporData> listData, Context context){
    ...
    public AdapterSelesai.MyHolder onCreateViewHolder(ViewGroup parent, int viewType){
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_lapor_selesai, parent, false);
        AdapterSelesai.MyHolder holder = new AdapterSelesai.MyHolder(v);
        return holder;

    }

    public void onBindViewHolder (AdapterSelesai.MyHolder holder, final int position){
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_name, tv_time, tv_status, status;
        Button petunjuk;
        ...
        public MyHolder(View itemView) {
            ...
            status = (TextView) itemView.findViewById(R.id.statusss);
